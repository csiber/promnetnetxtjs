...
export default function ServerHostingClient() {
  ...
  return (
    ...
    >
      <header className="space-y-4">
        <p className="section-kicker">Dedikált szerver</p>
        <h1 className="section-title mt-3">Szerver, ami kiszámíthatóan működik</h1>
        <p className="section-body max-w-2xl">
          Ha stabil, dedikált infrastruktúra kell backendhez vagy szolgáltatáshoz, akkor ez a logikus irány. A beállítás
          és az üzemeltetés dokumentált, a felelősség tiszta.
        </p>
      </header>
