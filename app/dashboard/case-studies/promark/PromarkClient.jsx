    ...
    >
      ...
      <div className="mt-9 flex flex-col gap-6 rounded-2xl border border-white/10 bg-card/80 p-5">
        ...
        >
          ...
          <h1 className="text-3xl font-RubikExtraBold text-foreground">PromARK – gamer közösség skálázható infrastruktúrája</h1>
        ...
        <section className="grid gap-3 rounded-2xl border border-white/10 bg-card/70 p-5">
          <h2 className="text-lg font-RubikMedium text-foreground">Mérföldkövek</h2>
          <div className="grid gap-3 md:grid-cols-2">
            {milestones.map((item) => (
              <div key={item.title} className="rounded-xl border border-white/10 bg-card/60 p-4">
                <h3 className="text-sm font-RubikMedium text-muted">{item.title}</h3>
        ...
        <section className="flex flex-col gap-4 rounded-2xl border border-sky-400/30 bg-sky-500/10 p-5 text-foreground">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-card/80 px-5 py-2 text-sm font-RubikMedium text-sky-100 transition hover:-translate-y-0.5 hover:bg-card/70"
