...
const highlights = [
  "Üzleti levelezés üzemeltetés",
  "Archiválás és hozzáféréskezelés",
  "MFA és biztonsági beállítások",
  "Migráció és átállás támogatás",
];

export default function MailHostingClient() {
  ...
  return (
    ...
    >
      <header className="space-y-4">
        <p className="section-kicker">Üzleti levelezés</p>
        <h1 className="section-title mt-3">Levelezés, ami megbízhatóan működik</h1>
        <p className="section-body max-w-2xl">
          Stabil üzleti levelezés, biztonsági beállításokkal és dokumentált átállással. Ha kell, integrációt is
          készítek a meglévő rendszerekhez.
        </p>
      </header>
