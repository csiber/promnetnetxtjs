...
import { FaTools, FaLaptop, FaTachometerAlt, FaHdd, FaRecycle, FaWindows, FaPrint, FaGamepad, FaCamera, FaBook } from 'react-icons/fa';
...
function Page() {
  return (
    ...
    >
      ...
      <h2 className="text-xl font-RubikMedium text-neutral-100">Tevékenységek :</h2>
      <p className="mt-2 text-neutral-300">Elektronikai szervizünk az alábbi tevékenységekben tud segítséget nyújtani:</p>
      <ul className="mt-4 space-y-2">
        ...
        <li className="flex items-center">
          ...
          <span>Operációs rendszer (többnyire Windows) telepítése, újratelepítés adatmentéssel, alap általános programokkal (nem üresen kapod)</span>
        </li>
        <li className="flex items-center">
        ...
        <li className="flex items-center">
          ...
          <span>Gamer PC összeszerelés, akár hozott alkatrészekből is</span>
        </li>
        <li className="flex items-center">
    ...
    <div className="mt-6 bg-gradient-to-r from-lime-400 to-teal-400 rounded-lg text-neutral-900 p-6 shadow-lg">
      <div className="flex items-center gap-x-3">
        ...
        <h2 className="text-xl font-RubikMedium">Segítségnyújtás akár aznap!</h2>
      </div>
      <p className="mt-4">
