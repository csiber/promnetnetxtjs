...
const highlights = [
  ...
  "Stabil sávszélesség",
  "Monitorozás és statisztikák",
  "Üzemeltetési támogatás",
];

export default function RadioServerHostingClient() {
  ...
  return (
    ...
    >
      <header className="space-y-4">
        <p className="section-kicker">Rádiószerver</p>
        <h1 className="section-title mt-3">Streaming infrastruktúra rádiókhoz</h1>
        <p className="section-body max-w-2xl">
          Rádiószerver hosting tiszta üzemeltetéssel. Stabil adás, monitorozás, és kontrollált beállítások.
        </p>
      </header>
