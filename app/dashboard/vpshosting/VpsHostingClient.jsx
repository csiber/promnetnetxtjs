...
const highlights = [
  "Külön erőforrás, dedikált kontroll",
  "Mentések és állapotfigyelés",
  "Saját deploy folyamat",
  "Skálázás igény szerint",
];

export default function VpsHostingClient() {
  ...
  return (
    ...
    >
      <header className="space-y-4">
        <p className="section-kicker">VPS hosting</p>
        <h1 className="section-title mt-3">VPS, amit nem kell babysittelni</h1>
        <p className="section-body max-w-2xl">
          Olyan VPS infrastruktúra, ahol tiszta a felelősség, dokumentált a beállítás és stabil az üzemeltetés. Ha backend
          projekthez kell, itt indulunk.
        </p>
      </header>
